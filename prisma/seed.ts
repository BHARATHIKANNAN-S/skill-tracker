...
async function main() {
  ...
  // Seeding 56 Curated LeetCode Problems distributed across the 25 topics
  const rawQuestions = [
    // 1. Arrays
  ...
  console.log(`Clearing completed. Seeding ${rawQuestions.length} curated LeetCode questions...`);
  ...
  console.log(`Curated ${rawQuestions.length} LeetCode problems.`);
